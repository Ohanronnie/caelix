...
- [Minimal Application](getting-started/minimal-application.md)
...
- [Cookies and Sessions](concepts/cookies-and-sessions.md)
- [OpenAPI and Swagger UI](advanced/openapi.md)
- [Responses and Errors](concepts/responses-and-errors.md)

# Advanced Usage

- [Guards and Interceptors](advanced/guards-and-interceptors.md)
- [Authentication and Authorization](advanced/authentication-and-authorization.md)
...
- [Microservices](advanced/microservices.md)
  - [Handlers and Client](advanced/microservices-handlers-and-client.md)
  - [NATS](advanced/microservices-nats.md)
  - [Redis](advanced/microservices-redis.md)
...
- [Database and Persistence](advanced/persistence.md)
- [Request Throttling](advanced/throttling.md)
- [Application Runtime](advanced/application-runtime.md)
- [Production Operations](advanced/production.md)
...
- [Macro Attributes](reference/macros.md)
- [Public Traits](reference/traits.md)
- [Error Response Shape](reference/error-response-shape.md)
- [Registration and Lifecycle Order](reference/registration-and-lifecycle.md)
