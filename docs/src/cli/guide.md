...
The default generated `Cargo.toml` tracks the latest Caelix release from
crates.io and uses the Actix backend. The Axum option disables default features
and enables `axum` instead.
